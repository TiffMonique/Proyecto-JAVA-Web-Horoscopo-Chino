...
<body>
	...
	<div class="wrapper fadeInDown">
		<h1>¿Que desea hacer, admin?</h1>


		<form method="get" action="consultaSignoChino">

			<input type="submit" value="Conoce animal" />

		</form>

			
		 <input type="submit" value="Busca Usuarios"> 
		 <input type="submit" action="login" class="btn btn-info btn-sm" value="Modificar Datos">


		<input type="submit" action="login" class="btn btn-info btn-sm"
